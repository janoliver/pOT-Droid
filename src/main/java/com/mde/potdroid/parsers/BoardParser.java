...
public class BoardParser extends DefaultHandler {
    ...
    public Board parse(String input) {
        ...
        board.requireChild(NUMBER_OF_THREADS_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mBoard.setNumberOfThreads(Integer.parseInt(attributes.getValue(NUMBER_OF_THREADS_ATTRIBUTE)));
            }
        });
        board.requireChild(NUMBER_OF_REPLIES_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mBoard.setNumberOfReplies(Integer.parseInt(attributes.getValue(NUMBER_OF_REPLIES_ATTRIBUTE)));
            }
        });
        board.requireChild(IN_CATEGORY_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                Category c = new Category(Integer.parseInt(attributes.getValue(IN_CATEGORY_ID_ATTRIBUTE)));
        ...
        thread.setElementListener(new ElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentThread = new Topic(Integer.parseInt(attributes.getValue(TopicParser.ID_ATTRIBUTE)));
        ...
        thread.requireChild(TopicParser.NUMBER_OF_HITS_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentThread.setNumberOfHits(Integer.parseInt(attributes.getValue(TopicParser.NUMBER_OF_HITS_ATTRIBUTE)));
            }
        });
        thread.requireChild(TopicParser.NUMBER_OF_REPLIES_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentThread.setNumberOfPosts(Integer.parseInt(attributes.getValue(TopicParser.NUMBER_OF_REPLIES_ATTRIBUTE)));
            }
        });
        ...
        first_post.requireChild(TopicParser.DATE_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentPost.setDateFromTimestamp(Integer.parseInt(attributes.getValue(TopicParser.DATE_TIMESTAMP_ATTRIBUTE)));
            }
        });
        first_post.getChild(TopicParser.ICON_TAG).setTextElementListener(new TextElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentPost.setIconId(Integer.parseInt(attributes.getValue(TopicParser.ICON_ATTRIBUTE)));
            }
        ...
        first_post.requireChild(TopicParser.USER_TAG).setTextElementListener(new TextElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentUser = new User(Integer.parseInt(attributes.getValue(TopicParser.ID_ATTRIBUTE)));
            }
        });
        ...
        flags.requireChild(TopicParser.IS_CLOSED_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentThread.setIsClosed(attributes.getValue(TopicParser.IS_CLOSED_ATTRIBUTE).equals("1"));
            }
        });
        flags.requireChild(TopicParser.IS_STICKY_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentThread.setIsSticky(attributes.getValue(TopicParser.IS_STICKY_ATTRIBUTE).equals("1"));
            }
        });
        flags.requireChild(TopicParser.IS_ANNOUNCEMENT_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentThread.setIsAnnouncement(attributes.getValue(TopicParser.IS_ANNOUNCEMENT_ATTRIBUTE).equals("1"));
            }
        });
        flags.requireChild(TopicParser.IS_IMPORTANT_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentThread.setIsImportant(attributes.getValue(TopicParser.IS_IMPORTANT_ATTRIBUTE).equals("1"));
            }
        });
        flags.requireChild(TopicParser.IS_GLOBAL_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentThread.setIsGlobal(attributes.getValue(TopicParser.IS_GLOBAL_ATTRIBUTE).equals("1"));
            }
        });
