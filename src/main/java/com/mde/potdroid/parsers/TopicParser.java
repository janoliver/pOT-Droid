...
public class TopicParser extends DefaultHandler {
    ...
    public Topic parse(String input) {
        ...
        thread.requireChild(NUMBER_OF_HITS_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mThread.setNumberOfHits(Integer.parseInt(attributes.getValue(NUMBER_OF_HITS_ATTRIBUTE)));
            }
        });
        thread.requireChild(NUMBER_OF_REPLIES_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mThread.setNumberOfPosts(Integer.parseInt(attributes.getValue(NUMBER_OF_REPLIES_ATTRIBUTE)));
            }
        });
        ...
        first_post.requireChild(DATE_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentPost.setDateFromTimestamp(Integer.parseInt(attributes.getValue(DATE_TIMESTAMP_ATTRIBUTE)));
            }
        });
        ...
        flags.requireChild(IS_ANNOUNCEMENT_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mThread.setIsAnnouncement(attributes.getValue(IS_ANNOUNCEMENT_ATTRIBUTE).equals("1"));
            }
        });
        ...
        message.requireChild(MESSAGE_EDITED_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentPost.setEdited(Integer.parseInt(attributes.getValue(MESSAGE_EDITED_ATTRIBUTE)));
            }
        });
        ...
        lastedit.getChild(USER_TAG).setTextElementListener(new TextElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentLastEditUser = new User(Integer.parseInt(attributes.getValue(ID_ATTRIBUTE)));
            }
        });
        lastedit.getChild(DATE_TAG).setStartElementListener(new StartElementListener() {
            ...
            @Override
            public void start(Attributes attributes) {
                mCurrentPost.setLastEditDateFromTimestamp(Integer.parseInt(attributes.getValue(DATE_TIMESTAMP_ATTRIBUTE)));
            }
        });
